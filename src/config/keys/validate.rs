...
pub(super) fn resolve_key_overrides(
    ...
    KeyBindings {
        ...
        shell: resolved(17),
        open: resolved(18),
        open_with: resolved(19),
        open_or_enter: resolved(20),
        go_to: resolved(21),
        toggle_selection: resolved(22),
        cycle_places_next: resolved(23),
        cycle_places_previous: resolved(24),
        go_parent: resolved(25),
        page_up: resolved(26),
        page_down: resolved(27),
        jump_first: resolved(28),
        jump_last: resolved(29),
        select_all: resolved(30),
        history_back: resolved(31),
        history_forward: resolved(32),
        sort: resolved(33),
        toggle_view: resolved(34),
        toggle_hidden: resolved(35),
        nav_left: resolved(36),
        nav_down: resolved(37),
        nav_up: resolved(38),
        nav_right: resolved(39),
        scroll_preview_left: resolved(40),
        scroll_preview_right: resolved(41),
        scroll_preview_up: resolved(42),
        scroll_preview_down: resolved(43),
    }
}
