...
pub(super) fn resolve_key_overrides(
    ...
    KeyBindings {
        ...
        cut: resolved(3),
        paste: resolved(4),
        extract_archive: resolved(5),
        symlink_absolute: resolved(6),
        symlink_relative: resolved(7),
        trash: resolved(8),
        delete_permanently: resolved(9),
        create: resolved(10),
        rename: resolved(11),
        restore_from_trash: resolved(12),
        copy_path: resolved(13),
        search_folders: resolved(14),
        search_files: resolved(15),
        filter_directory: resolved(16),
        zoxide: resolved(17),
        shell: resolved(18),
        open: resolved(19),
        open_with: resolved(20),
        open_or_enter: resolved(21),
        go_to: resolved(22),
        toggle_selection: resolved(23),
        cycle_places_next: resolved(24),
        cycle_places_previous: resolved(25),
        go_parent: resolved(26),
        page_up: resolved(27),
        page_down: resolved(28),
        jump_first: resolved(29),
        jump_last: resolved(30),
        select_all: resolved(31),
        history_back: resolved(32),
        history_forward: resolved(33),
        sort: resolved(34),
        toggle_view: resolved(35),
        toggle_hidden: resolved(36),
        nav_left: resolved(37),
        nav_down: resolved(38),
        nav_up: resolved(39),
        nav_right: resolved(40),
        scroll_preview_left: resolved(41),
        scroll_preview_right: resolved(42),
        scroll_preview_up: resolved(43),
        scroll_preview_down: resolved(44),
    }
}
