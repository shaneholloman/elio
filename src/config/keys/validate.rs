...
pub(super) fn resolve_key_overrides(
    ...
    KeyBindings {
        ...
        create: resolved(11),
        rename: resolved(12),
        restore_from_trash: resolved(13),
        copy_path: resolved(14),
        search_folders: resolved(15),
        search_files: resolved(16),
        filter_directory: resolved(17),
        zoxide: resolved(18),
        shell: resolved(19),
        open: resolved(20),
        open_with: resolved(21),
        open_or_enter: resolved(22),
        go_to: resolved(23),
        toggle_selection: resolved(24),
        cycle_places_next: resolved(25),
        cycle_places_previous: resolved(26),
        go_parent: resolved(27),
        page_up: resolved(28),
        page_down: resolved(29),
        jump_first: resolved(30),
        jump_last: resolved(31),
        select_all: resolved(32),
        history_back: resolved(33),
        history_forward: resolved(34),
        sort: resolved(35),
        toggle_view: resolved(36),
        toggle_hidden: resolved(37),
        nav_left: resolved(38),
        nav_down: resolved(39),
        nav_up: resolved(40),
        nav_right: resolved(41),
        scroll_preview_left: resolved(42),
        scroll_preview_right: resolved(43),
        scroll_preview_up: resolved(44),
        scroll_preview_down: resolved(45),
    }
}
